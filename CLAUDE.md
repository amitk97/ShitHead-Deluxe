...
- Match Stats keep players who left once their result was in (match FINISHED, or they had finished): the room listener hands the old/new lists to `rememberDepartedPlayers`, `buildMatchStats` reads `matchStatsPlayers()` and marks them "(left)"; cleared in `hideMatchEndUI` and on a room change.
